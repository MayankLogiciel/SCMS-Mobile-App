...
.service('printService', function($cordovaPrinter, $rootScope) {
    ...
    this.printUserForm = function(sewadar, isImageNotAvailable, skillList, vehicleList) {
        ...
        angular.forEach(skillList, function(val){
            skill = skill + '<li style="margin-bottom: 5px; float: left; width: 33.33%;">'+ val.name 
            + (val.selected ? ' ✓' : '') 
            + '</li>';
        })
        ...
        angular.forEach(vehicleList, function(val){
            vehicle = vehicle + '<li style="margin-bottom: 5px; float: left; width: 33.33%;">'+ val.name 
            + (val.selected ? ' ✓' : '')
             +'</li>';
        })
        ...
        var template = '<body style="font-size: 14px;">' +
            '<div style="max-width: 1170px;padding-right: 15px;padding-left: 15px;margin-right: auto;margin-left: auto; margin-top: 25px;">' +
                ...
                '<div style="display:block;margin-right:220px;">' +
                    ...
                    '<div style="margin-bottom:10px;"><label style="float:left;width:135px;">Residential Address</label><div style="display:block;min-height:13px;border-bottom:1px solid #ccc;margin-left:135px;">' + (sewadar.address ? sewadar.address : '') + '</div></div>' +
                    ...
                    '<div style="margin-bottom:10px;width: 50%;float:left;"><label style="float:left;width:75px;">Mobile No</label><div style="display:block;height:13px;border-bottom:1px solid #ccc;margin-left:75px;">' + (sewadar.mobile_number ? sewadar.mobile_number : '')+ '</div></div>' +
                    '<div style="margin-bottom:10px;width: 50%;float:left;"><label style="float:left;width:90px;">Landline No</label><div style="display:block;height:13px;border-bottom:1px solid #ccc;margin-left:90px;">' + (sewadar.land_line ? sewadar.land_line : '') + '</div></div>' +
                    '<div style="margin-bottom:10px;width: 50%;float:left;"><label style="float:left;width:90px;">Occupation</label><div style="display:block;height:13px;border-bottom:1px solid #ccc;margin-left:90px;">' + (sewadar.occupation_name ? sewadar.occupation_name : '') + '</div></div>' +
                ...
                '<div style="display:block;">' +
                    ...
                    '<div style="margin-bottom:10px;width: 33%;float:left;"><label style="float:left;width:95px;">Introduced By</label><div style="display:block;height:13px;border-bottom:1px solid #ccc;margin-left:95px;">' + (sewadar.ref_sewadar_name ? sewadar.ref_sewadar_name : '') + '</div></div>' +
                    '<div style="margin-bottom:10px;width: 33%;float:left;"><label style="float:left;width:75px;">Badge No.</label><div style="display:block;height:13px;border-bottom:1px solid #ccc;margin-left:75px;">' + (sewadar.ref_badge_number ? sewadar.ref_badge_number : '') + '</div></div>' +
                    '<div style="margin-bottom:10px;width: 33%;float:left;"><label style="float:left;width:80px;">Department</label><div style="display:block;height:13px;border-bottom:1px solid #ccc;margin-left:80px;">' + (sewadar.ref_department ? sewadar.ref_department : '') + '</div></div>' +
                    '<div style="clear: both;"></div>' +
                    '<div style="margin-bottom:10px;width: 99.1%"><label style="float:left;width:165px;">Full Address (Introducer)</label><div style="display:block;min-height:13px;border-bottom:1px solid #ccc;margin-left:165px;">' + (sewadar.address ? sewadar.address : '') + '</div></div>' +
                    '<br><br><br><br>' +
                    ...
                    '<div style="margin-top: 35px;text-align: center;">' +
                        ...
                        '<br><br>' +
                        '<div style="float: left;width: 100%;">' +
                            '<div style="width: 35%;float: left;"><div style="display:block;height:13px;border-bottom:1px solid #ccc;"></div><p style="text-align: center;">Name & Signature of Jathedar</p><label style="float:left;width:75px;">Badge No.</label><div style="display:block;height:13px;border-bottom:1px solid #ccc;margin-left:75px;">' + (sewadar.batch_no ? sewadar.batch_no : '') + '</div></div>' +
            ...
            '<div style="max-width: 1170px;padding-right: 15px;padding-left: 15px;margin-right: auto;margin-left: auto; margin-top: 25px;">' +
                ...
                '<div style="display:block;">' +
                    ...
                    '<div style="margin-top: 30px;">' +
                        ...
                        '<div>' +
                            '<div style="margin-bottom:10px;width: 40%;float:left;"><label style="float:left;width:18px;">I</label><div style="display:block;height:13px;border-bottom:1px solid #ccc;margin-left:18px;">' + (sewadar.name ? sewadar.name : '') + '</div></div>' +
                            '<div style="margin-bottom:10px;width: 35%;float:left;"><label style="float:left;width:65px;">S/D/W/O</label><div style="display:block;height:13px;border-bottom:1px solid #ccc;margin-left:65px;">' + (sewadar.guardian ? sewadar.guardian : '') + '</div></div>' +
                            '<div style="margin-bottom:10px;width: 15%;float:left;"><label style="float:left;width:130px;">hereby declares that</label></div>' +
                        '</div>' +
                        '<div>' +
                            '<div style="margin-bottom:5px;width: 100%;float:left;"><label style="float:left;width:25px;">1.</label><div style="display:block;margin-left:25px;">I am initiated from Beas.</div></div>' +
                            '<div style="margin-bottom:5px;width: 100%;float:left;"><label style="float:left;width:25px;">2.</label><div style="display:block;margin-left:25px;">That I have no badge at Beas or anywhere in Satsang Centres of India.</div></div>' +
                            '<div style="margin-bottom:5px;width: 100%;float:left;"><label style="float:left;width:25px;">3.</label><div style="display:block;margin-left:25px;">That my age is below 65 years as required by Beas/Centre. </div></div>' +
                            '<div style="margin-bottom:5px;width: 100%;float:left;"><label style="float:left;width:25px;">4.</label><div style="display:block;margin-left:25px;">That I am not addicted to any kind of intoxication and am physically fit for Sewa. </div></div>' +
                            '<div style="margin-bottom:5px;width: 100%;float:left;"><label style="float:left;width:25px;">5.</label><div style="display:block;margin-left:25px;">That I shall perform Sewa at centre or at Beas and in any department as required by the Management and shall abide to the changes in Sewa done by management from time to time. </div></div>' +
                            '<div style="margin-bottom:5px;width: 100%;float:left;"><label style="float:left;width:25px;">6.</label><div style="display:block;margin-left:25px;">That I shall be attend to my Sewa duties during Satsang days and otherwise as allottedto me by the management. </div></div>' +
                            '<div style="margin-bottom:5px;width: 100%;float:left;"><label style="float:left;width:25px;">7.</label><div style="display:block;margin-left:25px;">That I shall abide to the Rules and Regulations of centre and Beas and to the changes done in them from time to time. </div></div>' +
                            '<div style="margin-bottom:5px;width: 100%;float:left;"><label style="float:left;width:25px;">8.</label><div style="display:block;margin-left:25px;">That, in case of any mis-happening that occurs to me during Sewa, neither I nor my family members will claim any compensation from Centre or Beas as I am joining Sewa at my own free will. </div></div>' +
                            '<div style="margin-bottom:5px;width: 100%;float:left;"><label style="float:left;width:25px;">9.</label><div style="display:block;margin-left:25px;">That management shall have every right to cancel my badge without giving any reason. I shall accept it happily without any objection.</div></div>' +
                            '<div>' +
                                '<div style="margin-bottom:5px;float:left;"><label style="float:left;width:25px;">10.</label></div>' +
                                '<div style="margin-bottom:5px;width: 511px;float:left;"><label style="float:left;">That I am signing this document with my free will without any pressure. In the presence of </label></div>' +
                                '<div style="margin-bottom:5px;width: 17%;float:left;"><div style="display:block;height:13px;border-bottom:1px solid #ccc;"></div></div>' +
                            '</div>' +
                            '<br><br>' +
                            '<div style="clear: both;"></div>' +
