(function() {
      ...
      **/
      var SatsangDayController = function($log, $scope, $ionicHistory, $filter, $cordovaSQLite, $rootScope, $cordovaToast, $timeout, $ionicPopover, $state, satsangDayAttendanceListService) {
            var setup = function() {
                  $log.debug("Satsang_Day Controller"); 
                  $scope.currentDate =  $filter('date')(new Date(), 'yyyy-MM-dd'); 
                  $scope.today =  $filter('date')(new Date(),'EEEE, d MMMM, y');
                  $scope.count = 0; 
                  $scope.dirCrtl = {};
      ...
      SatsangDayController.$inject  = ['$log', '$scope', '$ionicHistory', '$filter', '$cordovaSQLite', '$rootScope', '$cordovaToast', '$timeout', '$ionicPopover', '$state', 'satsangDayAttendanceListService'];
      angular
